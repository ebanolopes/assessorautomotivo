...
<head>
	...
	<?php
		...
		echo $this->Html->css('layout_custom_acessor');
		...
		'home')); ?></h1>
			<div id="loginBox">
				<?php if (AuthComponent::user()): ?>
					Olá <strong><?php echo AuthComponent::user()['nome']; ?></strong>!
					<br />
					<?php echo $this->Html->link('Sair', array('controller' => 'usuarios', 'action' => 
		'logout')); ?>
				<?php else: ?>					
					<?php echo $this->Html->link('Entrar', array('controller' => 'usuarios', 'action' => 
		'login')); ?>
				<?php endif; ?>
			</div>
		</div>
